...
fogi_freqs = np.linspace(5.3405, 5.386, 1) #5.384
fogi_amplitude = 0.8
fogi_duration = 800
fogi_delay = 30
...
# photon_amplitude =  [0.164, 0.3, 0.424, 0.52, 0.6] # id=2
# photon_amplitude =[0.169, 0.309, 0.437, 0.534, 0.618] # id=0
# photon_amplitude =  [0.128, 0.234, 0.33, 0.404, 0.467] # id=1
photon_amplitude =  [0.16, 0.292, 0.412, 0.505, 0.583] # id=3
# photon_amplitude =  [0.184, 0.336, 0.476, 0.582, 0.672] # id=4
