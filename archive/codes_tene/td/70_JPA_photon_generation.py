...
pulse_dict = dict(
    # data0 = dict(target_freq=9.35, date="2024-10-13", acquire_time="220411"),
    # data1 = dict(target_freq=9.35, date="2024-10-13", acquire_time="220635"),
    # data2 = dict(target_freq=9.35, date="2024-10-13", acquire_time="220441"),
    # data3 = dict(target_freq=9.35, date="2024-10-13", acquire_time="220457"),

    data0 = dict(target_freq=9.35, date="2024-10-13", acquire_time="232707"),
    data1 = dict(target_freq=9.35, date="2024-10-13", acquire_time="232816"),
    data2 = dict(target_freq=9.35, date="2024-10-13", acquire_time="233043"),
    data3 = dict(target_freq=9.35, date="2024-10-13", acquire_time="233134"),
...
for k, v in tqdm(pulse_dict.items()):
    ...
    def fogi_sequence(half_pi:bool, JPA_direction=1) -> Sequence:
        ...
        seq.add(Square(amplitude=JPA_direction*1., duration=len(control_pulse)+100), JPA_port)
        if half_pi:
