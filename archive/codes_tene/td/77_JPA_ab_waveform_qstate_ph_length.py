...
fogi_freq = 5.3835 #5.391
fogi_amplitude = 0.6
ph_length = [400, 500, 600, 700, 800, 900, 999]#np.linspace(400, 500, 11)
    ...
    for p in tqdm(photon_amplitude):
        ...
        for l in tqdm(ph_length):
            ...
            def seq_I(fogi_amp, photon_amp=True):
                ...
                if photon_amp:
                    seq.add(Acquire(length), readout_port) 
