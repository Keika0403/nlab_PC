...
data = DataDict(
    ...
    waveform_I=dict(axes=["time", "fogi_delay", "photon_amp"]),
    waveform_zero_fogi_I=dict(axes=["time", "fogi_delay", "photon_amp"]),

    waveform_Q=dict(axes=["time", "fogi_delay", "photon_amp"]),
    waveform_zero_fogi_Q=dict(axes=["time", "fogi_delay", "photon_amp"]),

    waveform=dict(axes=["time", "fogi_delay", "photon_amp"]),
    waveform_zero_fogi=dict(axes=["time", "fogi_delay", "photon_amp"]),

    qstate = dict(axes=["fogi_delay", "photon_amp"]), 
    qstate_zero_fogi = dict(axes=["fogi_delay", "photon_amp"]),
)
data.validate()
