...
sequence_g = Sequence(port_list=[qubit_drive_port, readout_port, JPA_port, dig_port])
sequence_g.call(readout_single_shot_seq)
sequence_g.trigger([qubit_drive_port, readout_port, JPA_port, dig_port])
sequence_g.add(Delay(30), qubit_drive_port)
sequence_g.trigger([qubit_drive_port, readout_port, JPA_port, dig_port])
sequence_g.call(readout_single_shot_seq)
# sequence_g.draw()

sequence_e = Sequence(port_list=[qubit_drive_port, readout_port, JPA_port, dig_port])
