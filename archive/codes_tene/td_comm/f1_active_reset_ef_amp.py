...
amplitudes = np.linspace(0,0.1,51)
fogi_amplitude = 0.2
num_of_cycles = 3000
Appeared_anhm =-0.36485747
...
if measure_which == "tx":
    ...
    seq.add(SetDetuning(Appeared_anhm), qubit_drive_port_tx)
    ...
    seq.add(FlatTop(Gaussian(amplitude=amplitude, fwhm=10, duration=20), top_duration=1000), qubit_drive_port_tx)
    ...
    seq.add(FlatTop(Gaussian(amplitude=amplitude, fwhm=10, duration=20), top_duration=1000), qubit_drive_port_rx)
