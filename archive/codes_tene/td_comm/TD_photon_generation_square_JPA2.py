...
repetition = 10
amplitude = 1.15
fogi_drive_freq = 5.6125
drive_duration = 20000
measurement_length = 600
hvi_trigger.trigger_period(70000)
...
seq1.add(Acquire(measurement_length), dig_port)
...
seq2.add(Acquire(measurement_length), dig_port)
fogi_port.if_freq = fogi_drive_freq - fogi_lo_freq
seq2.compile()
...
sequence_JPA.add(Square(amplitude=0.83, duration=len(i_fogi)), JPA_port)
