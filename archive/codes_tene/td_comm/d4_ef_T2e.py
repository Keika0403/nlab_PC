...
half_delay = Variable("half_delay", np.linspace(0, 20000, 101), "ns")
...
sequence.add(SetDetuning(anharmonicity), qubit_drive_port)
sequence.call(ef_half_pi_seq)
sequence.add(Delay(half_delay), qubit_drive_port)
