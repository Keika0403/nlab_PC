...
drive_amplitude = np.linspace(0, 0.5, 51)
cycles = 3000
num_of_pulses = 5

var = Variables()
v1 = Variable('drive_amplitude', value_array=drive_amplitude, unit='Volt')
var.add(v1)
var.compile()

if measure_which == "tx":
    ef_pi_pulse_tx.params['amplitude']=v1
    ...
    ef_pi_pulse_rx.params['amplitude']=v1
...
# check_sequence_formulti(seq, var, [100])
