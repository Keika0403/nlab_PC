...
half_delay = np.arange(0, 8000, 51)
detuning = +0.0004
target_frequency = 10.414
drive_amplitudes = np.sqrt(np.linspace(0, 0.04**2, 21))
num_of_cycles = 3000
...
ge_half_pi_seq = ge_half_pi_seq_rx
ge_pi_seq = ge_pi_seq_rx
readout_lo_freq = readout_lo_freq_rx
    ...
    with DDH5Writer(data, data_path, name=measurement_name) as writer:
        ...
        for update_command in tqdm(var.update_command_list):
            ...
            writer.add_data(
                ...
                delay=seq.variable_dict['half_delay'][0].value*2+ge_pi_pulse_rx.params["duration"],
